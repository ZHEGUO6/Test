 ...
 * data定义
 */
const form = reactive<API.User.Add & { captcha: string; saveTime: number }>({
  nickname: '',
  loginPwd: '',
  captcha: '',
  saveTime: 0,
...
const setInitialAvatars = async () => {
  ...
  localStorage.setItem('initialAvatars', JSON.stringify(links))
  initialAvatars.value = links
}

// 从本地数据恢复系统自带头像数据
const recoverInitialAvatars = () => {
  initialAvatars.value = JSON.parse(localStorage.getItem('initialAvatars')) as Array<string>
}
...
<template>
  <el-scrollbar>
    <el-form
      ...
      class="registryForm"
    >
      <el-form-item label="角色" :required="true" :prop="ValidateRegistryEnum.Type">
        <el-input v-model="form.nickname" placeholder="请选择您的角色" />
      </el-form-item>
      <el-form-item label="昵称" :required="true" :prop="ValidateRegistryEnum.NickName">
        <el-input v-model="form.nickname" placeholder="请输入昵称" />
      </el-form-item>
      <el-form-item label="密码" :required="true" :prop="ValidateRegistryEnum.LoginPwd">
        <el-input
          type="password"
      ...
      <el-form-item label="确认密码" :required="true" :prop="ValidateRegistryEnum.ConfirmPwd">
        <el-input
          type="password"
          v-model="form.loginPwd"
    ...
    <el-drawer v-model="useMoreSettings">
      ...
      <el-form-item label="头像" :prop="ValidateRegistryEnum.Avatar">
        <ul class="initialAvatarContainer">
          <el-avatar v-for="item in initialAvatars" :src="item" />
        </ul>
        <el-switch
          v-model="useUploadAvatar"
          active-text="使用系统自带头像"
          inactive-text="使用自己的头像"
        />
        <el-upload></el-upload>
      </el-form-item>
      <el-form-item label="邮箱" :prop="ValidateRegistryEnum.Email">
        <el-input v-model="form.mail" />
      </el-form-item>
      <el-form-item label="QQ号" :prop="ValidateRegistryEnum.QQ">
        <el-input v-model="form.qq" />
      </el-form-item>
      <el-form-item label="微信号" :prop="ValidateRegistryEnum.Wechat">
        <el-input v-model="form.wechat" />
      </el-form-item>
      <el-form-item label="个人介绍" :prop="ValidateRegistryEnum.Intro">
        <el-input v-model="form.intro" />
      </el-form-item>
      <el-form-item label="地址" :prop="ValidateRegistryEnum.Address">
        <el-select></el-select>
        <el-text>国家</el-text>
        <el-select></el-select>
        <el-text>省份</el-text>
      ...
      <el-form-item label="手机号" :prop="ValidateRegistryEnum.Phone">
        <el-input v-model="form.phone" />
      </el-form-item>
      <el-form-item label="生日" :prop="ValidateRegistryEnum.BirthDay">
