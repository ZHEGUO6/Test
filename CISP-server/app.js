...
const { AdminRouter, CommentReplyRouter, CommentRouter, FriendRouter, GroupRouter, MessageRouter, NewsRouter, SearchRouter, SearchImgRouter, UnableRouter, UserRouter, CaptchaRouter,ImageRouter } = require('./routes');
