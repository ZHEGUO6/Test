...
Router.post('/add', async function (req, res, next) {
    const FriendsInstance = await commonValidate(req, next, Friends, validateAdd, 'create', async ({ uId, fId }) => {
...
Router.post('/addList', async function (req, res, next) {
    const set = new Set();
    const FriendsInstances = await commonValidate(req, next, Friends, validateAdd, 'bulkCreate', async ({ uId, fId }) => {
        if (set.has(fId)) {
...
Router.put('/:fId', async function (req, res, next) {
    ...
    const result = await commonValidate(req, next, Friends, validateModify, 'update', null, {
        where: {
            friendId: fId
        },
        returning: true
